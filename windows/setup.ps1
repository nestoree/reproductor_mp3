...
# --- Step 2: Update MSYS2 ---
Write-Step "Paso 2/5: Actualizando MSYS2"
...
Write-Step "Paso 3/5: Dependencias"
...
# --- Step 4: Compile ---
Write-Step "Paso 4/5: Compilando"
...
Write-Step "Paso 5/5: Acceso directo en el escritorio"

$desktop = [Environment]::GetFolderPath("Desktop")
$shortcutPath = "$desktop\Reproductor App.lnk"
$icoPath = "$srcDir\reproductor.ico"

try {
    $wshell = New-Object -ComObject WScript.Shell
    $shortcut = $wshell.CreateShortcut($shortcutPath)
    $shortcut.TargetPath = "$srcDir\run.bat"
    $shortcut.WorkingDirectory = "$srcDir"
    $shortcut.Description = "Reproductor App - Reproductor de musica"
